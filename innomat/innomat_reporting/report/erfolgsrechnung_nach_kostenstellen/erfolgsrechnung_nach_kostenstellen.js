...
frappe.query_reports["Erfolgsrechnung nach Kostenstellen"] = {
    "filters": [
        {
            fieldname: "company",
...
// NOTE: Zweizeilige Spaltentitel erreicht man so: <script type="text/javascript">$("div.dt-row-header").css("height","50px");</script>
//       Müsste man aber ausführen wenn Bericht geladen wird.
